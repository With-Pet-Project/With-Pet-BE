...
public class MypageController {
    ...
    @PatchMapping()
    public ResponseEntity<ApiResponse<Void>> changeUserInfo(@AuthenticationPrincipal PrincipalDetails principalDetails,
    ...
    public ResponseEntity<ApiResponse<ViewMypageResponseDto>> viewMypage(
        ...
        ApiResponse<ViewMypageResponseDto> response = new ApiResponse<>(200, ResponseMessages.VIEW_MESSAGE.getContent(),
